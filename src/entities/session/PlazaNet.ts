...
import { PLAZA_WS_URL } from '@/shared/config';
import type { JoinResult, PlazaAgentInfo, PlazaMessage, SessionEvents } from './protocol';
...
export class PlazaNet {
  ...
  private connect(): void {
    ...
    const base = PLAZA_WS_URL || `${proto}://${location.host}/api/plaza`;
